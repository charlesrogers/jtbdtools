...
![Segment DNA divergence
chart](reference/figures/readme-segment-profiles.png)

The index heatmap shows exactly where each segment over- or
under-indexes vs the population (100 = average):
...
|                      | [`plot_segment_profiles()`](https://charlesrogers.github.io/jtbdtools/reference/plot_segment_profiles.md)                 | Diverging bar chart of segment DNA                  |
