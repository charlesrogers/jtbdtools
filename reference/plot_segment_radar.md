...
All segments on one radar chart using index values (100 = population
average). Spikes show where a segment is over-represented; dips show
...
- max_attrs:
  ...
  Maximum number of attributes on the radar (default: 8)
