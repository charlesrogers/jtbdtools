...
Summarizes segment comparison results with significance counts and
percentages.

## Usage

``` r
get_seg_comp.build.linear(total_pop, original_df, new_table)
```
...
- original_df:
  ...
  Original data frame to append to

- new_table:

  New segment comparison table

## Value

An updated data frame with segment comparison summary
